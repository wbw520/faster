...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', type=str, default="/home/wangbowen/data/EPIC_KITCHES_2018/object_detection_images")
...
def main(args):
    ...
    model = fasterrcnn_resnet_fpn(num_classes=352, pretrained=False)
    model.to(device)
